...
void background_draw(){
	...
	graph_rect(X_FOUNDATION_STACK0, Y_FOUNDATION_STACK0, FOUNDATION_STACK0_WIDTH, FOUNDATION_STACK0_HEIGHT, EMPTY_PILE_COLOR_TOP, true);
	graph_rect(X_FOUNDATION_STACK1, Y_FOUNDATION_STACK1, FOUNDATION_STACK1_WIDTH, FOUNDATION_STACK1_HEIGHT, EMPTY_PILE_COLOR_TOP, true);
